...
import './quiz.css'
import pass from '../result logo/c9ae85b4431228f0d59e2ab9e4515378.gif'
import fail from '../result logo/icegif-752.gif'
function Quiz() {
    ...
    <div className='container'>
      ...
      <div  className='quiz-app'>
        ...
        <div  className='questions'>
          <h3><span>{questionIndex + 1}.</span> {questions[questionIndex].question.text}</h3>
        </div>
        {
